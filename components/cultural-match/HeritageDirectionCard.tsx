      ...
      <div className="flex flex-wrap items-start justify-between gap-6">
        <div className="flex min-w-0 flex-col gap-3">
          <div className="flex flex-wrap items-center gap-3">
            <span className="font-mono text-[11px] tracking-[0.2em] text-[var(--color-silver-600)]">
        ...
        <div className="text-right">
          ...
          <div className="font-sans text-[28px] leading-none text-[var(--color-ivory)] sm:text-[32px]">
            {match.match_score}
      ...
      {selection && (
        <div className="flex border-t border-[var(--color-line)] pt-6">
          <button
            ...
            className={`inline-flex items-center gap-2.5 rounded-full border px-6 py-3 text-[12px] font-medium tracking-[0.14em] uppercase transition-all duration-300 active:scale-[0.97] ${selection.selected
