...
export function NaturalLanguageInput({
  ...
  return (
    <section className="flex flex-col gap-5">
      ...
      <div className="glass-panel group relative rounded-[var(--radius-lg)] p-6 transition-colors duration-300 focus-within:border-[var(--color-line-strong)]">
        <textarea
          value={value}
          ...
          className="w-full resize-none bg-transparent font-editorial text-[22px] leading-[1.4] tracking-[-0.005em] text-[var(--color-ivory)] placeholder:text-[var(--color-silver-500)]/70 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60 sm:text-[26px]"
        />
        <div className="mt-5 flex flex-col gap-3 border-t border-[var(--color-line)] pt-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            disabled={disabled}
            className="self-start text-[11px] tracking-[0.14em] text-[var(--color-silver-400)] uppercase transition-colors hover:text-[var(--color-ivory)] disabled:opacity-40 sm:self-auto"
          >
