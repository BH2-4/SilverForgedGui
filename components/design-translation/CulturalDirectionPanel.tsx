      ...
      <div className="glass-panel flex flex-col gap-8 rounded-[var(--radius-lg)] p-8 sm:p-10">
        {reference ? (
            ...
            <div className="flex flex-wrap items-start justify-between gap-6">
              <div className="flex min-w-0 flex-col gap-3">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="font-mono text-[10px] tracking-[0.16em] text-[var(--color-silver-600)]">
                    {reference.match_id}
                  </span>
                </div>
              ...
              {match && (
                <div className="text-right">
                  ...
                  <div className="font-editorial text-4xl leading-none text-[var(--color-ivory)]">
                    {match.match_score}
            ...
            <div className="flex flex-col gap-4 border-t border-[var(--color-line)] pt-6">
              ...
              <ul className="flex flex-col gap-2.5">
                {brief.documented_cultural_facts.map((fact, i) => (
                  ...
                  >
                    <span>{fact.fact}</span>
                    <span className="flex flex-wrap items-center gap-3 text-[10px] tracking-[0.1em] text-[var(--color-silver-500)]">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-editorial text-2xl leading-[1.15] text-[var(--color-silver-200)]">
